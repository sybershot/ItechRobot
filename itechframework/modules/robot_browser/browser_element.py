...
class BrowserElement:
    ...
    def input_text(self, text):
        element = self.browser.driver.find_element(self.by, self.locator)
    ...
    def click_element(self, max_attempts=5):
        ...
        try:
            ...
            ad_banner_close = self.browser.driver.find_elements('xpath', self.GOOGLE_AD_BANNER_CLOSE_LOCATOR)
            if ad_banner_close:
    ...
    def update_element(self):
        return self.browser.driver.find_element(self.by, self.locator)
